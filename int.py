...
def update_data():
    ...
    data_label_6.configure(text=str(data_6))  # Update Kw Limit
...
def open_debug_window():
    ...
    debug_window.attributes("-fullscreen", True)  # Set to fullscreen mode
    ...
    for category, items in categories.items():
        ...
        category_frame.place(x=20 if category != "Test" else 420, y=y_position if category != "Test" else 80)
...
def update_gui(msg):
    global data_1, data_2, data_3, data_4, data_5, data_6, last_r2d_state ,speed
